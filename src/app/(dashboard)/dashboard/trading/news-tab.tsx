      ...
      {trending.length > 0 && (
        <div className="bg-gradient-to-r from-orange-50 to-yellow-50 border border-orange-200 rounded-lg p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm font-semibold text-orange-900">Trending Symbols (24h)</h3>
          </div>
          <div className="flex flex-wrap gap-2">
            {trending.map((item) => (
              ...
              >
                {item.symbol}
                <span className="ml-1.5 text-xs opacity-75">({item.mention_count})</span>
              </button>
            ))}
          </div>
        </div>
              ...
              <div className="flex items-start justify-between gap-4 mb-3">
                <div className="flex-1">
                  <a
                    ...
                    className="text-lg font-bold text-gray-900 hover:text-blue-600 transition line-clamp-2 flex items-start gap-2"
                  >
                    {article.headline}
                ...
                <div className="flex flex-wrap gap-2">
                  {article.symbols.map((symbol) => (
                    <button
                      ...
                      className={cn(
                        'px-2 py-1 rounded text-xs font-medium font-mono transition',
                        activeFilter === symbol
